...
export default function PembayaranSaya() {
  ...
  const [dialog, setDialog] = useState({
    open: false,
    tagihan_id: null as number | null,
  })
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setSnack({
        open: true,
        message: 'Bukti berhasil diupload, menunggu verifikasi admin',
        severity: 'success',
      })
  ...
  return (
    <Box>
          ...
          <Grid item>
            <TextField
              ...
              onChange={(e) =>
                setFilter((f) => ({
                  ...f,
                  tahun: parseInt(e.target.value) || 2026,
                }))
              }
              sx={{ width: 100 }}
            />
                  ...
                  <TableRow key={item.id}>
                    ...
                    <TableCell>
                      {(() => {
                        ...
                        if (p?.status === 'ditolak')
                          return (
                            <Chip label='Ditolak' color='error' size='small' />
                          )
                        return (
                          <Chip
                            label='Belum Bayar'
                      ...
                      {(() => {
                        ...
                        return (
                          <Button
                            ...
                            variant='contained'
                            color={
                              p?.status === 'ditolak' ? 'warning' : 'primary'
                            }
                            onClick={() => openBayar(item.id)}
                          >
                            {p?.status === 'ditolak' ? 'Bayar Ulang' : 'Bayar'}
                          </Button>
                        )
                      })()}
                    </TableCell>
      ...
      <Dialog
        open={dialog.open}
        onClose={() => setDialog({ open: false, tagihan_id: null })}
        maxWidth='md'
        fullWidth
        fullScreen={isMobile}
      >
                ...
                <Grid container spacing={2} alignItems='start'>
                  <Grid item xs={12} md={4}>
                    ...
                    <Box sx={{ pl: 1 }}>
                      ...
                      <Typography
                        ...
                        sx={{ mb: 0.5 }}
                      >
                        2. Transfer ke rekening di tengah
                      </Typography>
                      <Typography
                        variant='body2'
                        color='text.secondary'
                  ...
                  <Grid item xs={12} md={4}>
                    ...
                    >
                      ...
                      >
                        Bendahara RT 03 RW 016 — Cluster Madrid
                      </Typography>
                    </Box>
                  </Grid>
                  <Grid item xs={12} md={4}>
                    ...
                    >
                      ...
                      >
                        ...
                        <input
                          ...
                          hidden
                          onChange={(e) =>
                            handleBukti(e.target.files?.[0] || null)
                          }
                        />
                      </Button>
                      {buktiPreview && (
                  ...
                  <Grid item xs={12} md={4}>
                    ...
                    <Box sx={{ pl: 1 }}>
                      <Typography
                        ...
                        sx={{ mb: 0.5 }}
                      >
                        1. Buka e-wallet / mobile banking
                      </Typography>
                      <Typography
                        variant='body2'
                        color='text.secondary'
                      ...
                      <Typography variant='body2' color='text.secondary'>
                        6. Simpan bukti & upload di kanan
                      </Typography>
                    </Box>
                  </Grid>
            ...
            >
              ...
              >
                <Typography variant='body2' color='text.secondary' mb={1}>
                  Metode:{' '}
                  <strong>
                    {previewData.pembayaran?.metode === 'transfer'
                      ? 'Transfer Bank'
                      : previewData.pembayaran?.metode === 'qris'
                        ? 'QRIS'
                        : previewData.pembayaran?.metode}
                  </strong>{' '}
                  — Rp{' '}
                  {Number(
                    previewData.pembayaran?.nominal || previewData.nominal,
                  ).toLocaleString()}
                </Typography>
                {previewData.pembayaran?.bukti_url ? (
                  <img
                    src={previewData.pembayaran.bukti_url}
                    alt='Bukti Bayar'
                    style={{
                      maxWidth: '100%',
                      maxHeight: 400,
                ...
                {previewData.pembayaran?.tgl_bayar && (
                  <Typography
                    ...
                    mt={1}
                  >
                    Tanggal bayar: {previewData.pembayaran.tgl_bayar}
                  </Typography>
                )}
                {previewData.status === 'lunas' &&
                  previewData.pembayaran?.verifikator && (
                    <Typography
                      variant='caption'
                      color='text.secondary'
                      display='block'
                    ...
                    >
                      Diverifikasi oleh:{' '}
                      <strong>{previewData.pembayaran.verifikator.nama}</strong>
                    </Typography>
                  )}
                {previewData.pembayaran?.status === 'ditolak' && (
                  <Typography
                    ...
                    mt={0.5}
                  >
                    Alasan penolakan: {previewData.pembayaran.keterangan}
                  </Typography>
                )}
              </Box>
            </Box>
